<script lang="ts">
	...
	onMount(async () => {
		...
		// Changelog modal disabled — Agent1 manages its own releases
		...
		// Version update check disabled — Agent1 manages its own releases
...
<!-- Version update toast disabled — Agent1 manages its own releases -->
	...
	<div class="app relative">
		...
		>
			...
			{:else}
				...
				<div class="flex-1 flex flex-row overflow-auto relative">
				{#if localDBChats.length > 0}
